class Form{
    ...
    display(){
        ...
        this.button.position(displayWidth/2 + 100, displayHeight+180);
        this.reset.position(displayWidth/2 + 300, displayHeight+180);
        ...
        this.radio2.position(displayWidth/2 +200, 560);
